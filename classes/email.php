...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        $mail->setFrom("cuentas@casaAbuela.com");
        $mail->addAddress("cuentas@casaAbuela.com","CasaAbuela.com");
        ...
        en Appsalon, solon debes confirmarla presionando el siguiente enlace</p>";
    ...
    public function enviarIntrucciones() {
        ...
        $contenido .= "<p>Presiona aqui: <a href='".$_ENV["APP_URL"]."/recuperar?token=".$this->token."'> Reestablecer Password </p>";
        $contenido .= "<p>Si tu no solicitaste esta cuenta puede ignorar el mensaje</p>";
        $contenido .= "</html>";
